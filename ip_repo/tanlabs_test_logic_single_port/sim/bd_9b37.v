...
//--------------------------------------------------------------------------------
//Command: generate_target bd_9b37.bd
//Design : bd_9b37
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_9b37,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9b37,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "test_logic_single_port_system_ila_0_1.hwdef" *) 
module bd_9b37
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tid,
    SLOT_0_AXIS_tkeep,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN test_logic_single_port_controller_clk, FREQ_HZ 33000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 3, TUSER_WIDTH 64" *) input [511:0]SLOT_0_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_1_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXIS, CLK_DOMAIN test_logic_single_port_controller_clk, FREQ_HZ 33000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 3, TUSER_WIDTH 64" *) input [511:0]SLOT_1_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_1_AXIS TUSER" *) input [63:0]SLOT_1_AXIS_tuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_1_AXIS TVALID" *) input SLOT_1_AXIS_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_2_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXIS, CLK_DOMAIN test_logic_single_port_controller_clk, FREQ_HZ 33000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 3, TUSER_WIDTH 8" *) input [63:0]SLOT_2_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_3_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_3_AXIS, CLK_DOMAIN test_logic_single_port_controller_clk, FREQ_HZ 33000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 3, TUSER_WIDTH 8" *) input [63:0]SLOT_3_AXIS_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_3_AXIS TID" *) input [2:0]SLOT_3_AXIS_tid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS, ASSOCIATED_CLKEN aclken, ASSOCIATED_RESET resetn, CLK_DOMAIN test_logic_single_port_controller_clk, FREQ_HZ 33000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  wire [63:0]net_slot_1_axis_tuser;
  ...
  assign Conn1_TUSER = SLOT_1_AXIS_tuser[63:0];
  ...
  assign Conn3_TID = SLOT_3_AXIS_tid[2:0];
  ...
  bd_9b37_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe25(net_slot_3_axis_tid),
        .probe26(net_slot_3_axis_tkeep),
        .probe27(net_slot_3_axis_tuser),
        .probe28(net_slot_3_axis_tvalid),
        .probe29(net_slot_3_axis_tready),
        .probe3(net_slot_0_axis_tuser),
        .probe30(net_slot_3_axis_tlast),
        .probe31(net_slot_3_apc_pc_asserted),
  ...
  bd_9b37_slot_0_apcs_0 slot_0_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_9b37_slot_1_apcs_0 slot_1_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_9b37_slot_2_apcs_0 slot_2_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
  ...
  bd_9b37_slot_3_apcs_0 slot_3_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
        .pc_asserted(net_slot_3_apc_pc_asserted),
        .pc_axis_tdata(Conn3_TDATA),
        .pc_axis_tid(Conn3_TID),
        .pc_axis_tkeep(Conn3_TKEEP),
