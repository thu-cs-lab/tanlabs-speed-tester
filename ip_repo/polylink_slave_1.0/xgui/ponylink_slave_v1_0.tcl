...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SERDES_REG_IN"
  ipgui::add_param $IPINST -name "SERDES_REG_OUT"
  ipgui::add_param $IPINST -name "MASTER_PARBITS"
  ipgui::add_param $IPINST -name "SLAVE_PARBITS"
  ipgui::add_param $IPINST -name "MASTER_TIMINGS"
  ipgui::add_param $IPINST -name "SLAVE_TIMINGS"
  ipgui::add_param $IPINST -name "TDATA_WIDTH"
